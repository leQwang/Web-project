//Get the form
const customerRegistartionForm = document.querySelector('#registerCustomer-form');

//Get the different submit buttons
const customerSubmitBtn = document.querySelector('#registerCustomer-btn');
...
customerSubmitBtn.addEventListener('click', (event) => {
    ...
    let errorMessage = validateCustomerForm();

    if(errorMessage === ''){
        customerRegistartionForm.submit();
    }
    else{
        alert(errorMessage);
    }
...
function validateCustomerForm() {
    ...
    errorMessage += validateField(address, "Address");
    return errorMessage;
}
